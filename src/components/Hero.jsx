...
const Badge = ({ icon, label, className, delay = 0 }) => (
  <motion.div
    ...
    className={`absolute flex items-center gap-1.5 px-3 py-1.5 rounded-lg
      bg-[#0f0f1e] border border-indigo-500/25 text-xs font-medium text-indigo-300
      shadow-lg shadow-indigo-500/10 ${className}`}
  >
    {icon}
    {label}
  </motion.div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] mb-5"
          >
            <span className="text-white">Bhupesh</span>
            <br />
            <span className="text-glow">Nagda</span>
          </motion.h1>
          ...
          >
            ...
            <span className="text-indigo-400 font-semibold text-lg sm:text-xl mono">
              <TypeAnimation
                sequence={[
                  "IoT Developer", 2000,
          ...
          >
            ...
            <span className="text-indigo-300 font-medium"> national hackathon-winning</span> products.
          </motion.p>
          ...
          >
            {[
              { n: "8+",  l: "Hackathon Wins" },
              { n: "7+",  l: "IoT Projects" },
              { n: "3mo", l: "IoT Training" },
            ].map((s, i) => (
              <motion.div
                key={s.l}
        ...
        >
          {/* Outer glow */}
          <div className="absolute inset-0 rounded-full bg-gradient-to-br from-indigo-500/20 via-violet-500/10 to-cyan-500/10 blur-2xl scale-110" />
          ...
          <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-72 lg:h-72 rounded-full
            ...
            {profileSrc ? (
              ...
              <div className="text-center select-none">
                <div className="text-6xl lg:text-7xl font-black text-glow leading-none">BN</div>
