...
/* Map category → vibrant accent color */
const catAccent = {
  "AI / Software":    "#3B82F6",
  "AI / IoT":         "#8B5CF6",
  "Robotics / IoT":   "#06B6D4",
...
const FeaturedCard = ({ project, inView }) => {
  const accent = catAccent[project.category] || "#8B5CF6";
  return (
    <motion.div
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            ...
            <h3 className="text-white font-black text-xl sm:text-2xl leading-tight text-heading
              transition-colors"
...
const ProjectCard = ({ project, index, inView }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-white font-bold text-sm leading-snug mb-2 text-heading
      ...
      <div className="flex gap-4 pt-3 border-t border-white/[0.05]">
        <a href={project.github} target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 text-xs text-slate-600 hover:text-white transition-colors cursor-pointer">
          <FaGithub size={11} /> Code
        </a>
        <a href={project.demo} target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 text-xs text-slate-600 transition-colors cursor-pointer"
